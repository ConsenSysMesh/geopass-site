...
function IndexPage() {
  return (
    ...
    <div className="p-4">
      ...
      <p> 
        The GeoPass platform will allow anyone to build novel consumer applications on top of location information, without jeopardizing the privacy of their users.
      </p>
    </div>
    </Layout>
  );
